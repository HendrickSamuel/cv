...
export const RESUME_DATA = {
  ...
  summary:
    "I am a Frontend Developer that started as a Backend Developer. I therefore have a good understanding of the full stack. This aspect helps me on a daily basis to better understand the needs of the project and to be able to communicate with the other team members.",
